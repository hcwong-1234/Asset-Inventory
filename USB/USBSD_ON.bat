...
reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\sdbus" /v Start /t REG_DWORD /d 3 /f

:done
echo USB storage devices and SD card reader have been enabled.
endlocal
